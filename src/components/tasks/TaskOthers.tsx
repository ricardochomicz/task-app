...
const TaskOthers: React.FC<TaskOthersProps> = ({
    tasks,
    editingTask,
    showColorPicker,
    setEditingTask,
    ...
    return (
        <div>
            <div className="flex items-center gap-2 mb-4 mt-5">
                ...
                <h2 className="text-lg text-white font-semibold mt-4">Outras tarefas</h2>
                        ...
                        <div key={task.id} className={`p-4 rounded-xl shadow-md ${task.color} relative`}>
                            ...
                            <div className="flex justify-between items-center pb-2">
                                ...
                                <button onClick={() => toggleFavorite(task.id as number)}>
                                    <Star size={20} className="text-yellow-500 transition-colors" />
                                </button>
                            </div>
